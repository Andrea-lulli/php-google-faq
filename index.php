...
$arrayDomande = [
    ...
    [
        ...
        'risposte' => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.
    ...
    <header class="fixed pt-3">
        <div class="d-flex m-1 justify-content-between">
            ...
            <div class="col-3 d-flex align-items-center justify-content-between ">
                ...
                <div class="col-9 text-secondary fs-5 mx-1 fw-bold">
